...
let make_qand concl1 concl2 =
  ...
  | QConstraints q, concl when Terms.is_true_constraints q -> concl
  | concl, QConstraints q when Terms.is_true_constraints q -> concl 
...
let make_qor concl1 concl2 =
  ...
  | QConstraints q, _ when Terms.is_true_constraints q -> QTrue
  | _, QConstraints q when Terms.is_true_constraints q -> QTrue 
