...
val mk_ctx_proctmpl :
  ...
  (bool * Name.ident * Name.ident) list *
  Name.ident * Name.ident list *
  (Name.ident * int) list -> ctx_process_template
val mk_def_proctmpl :
  Name.ident *
  (Syntax.expr * Name.ident * Syntax.expr)
type context = {
...
val ctx_add_ty :
  context -> Name.ident * Input.type_class -> context
...
val ctx_add_fsys :
  ...
  context
val ctx_add_ch :
  context -> Name.ident * Name.ident -> context
val ctx_add_param_ch :
  context -> Name.ident * Name.ident -> context
val ctx_add_proctmpl : context -> ctx_process_template -> context
val ctx_add_event : context -> Name.ident * int -> context
val ctx_add_ext_syscall :
  context ->
  Name.ident * Input.arg_type list -> context
val ctx_add_ext_attack :
  context ->
  Name.ident * Name.ident *
  Input.arg_type list -> context
...
val ctx_add_or_check_fact :
  loc:Location.t ->
  context -> Name.ident * int -> context
val ctx_add_or_check_lfact :
  loc:Location.t ->
  context -> Name.ident * int -> context
val ctx_add_or_check_inj_fact :
  loc:Location.t ->
  context -> Name.ident * int -> context
val def_add_ext_eq :
  definition ->
...
val def_add_const :
  definition ->
  Name.ident * Syntax.expr option -> definition
...
val def_add_proctmpl :
  ...
  Name.ident ->
  (Syntax.expr * Name.ident * Syntax.expr)
    list -> local_definition -> Syntax.cmd -> definition
val def_add_ext_syscall :
  definition ->
  Name.ident *
  (Input.arg_type * Name.ident) list *
  Syntax.cmd -> definition
val def_add_ext_attack :
  definition ->
  Name.ident * Name.ident *
  (Input.arg_type * Name.ident) list *
  Syntax.cmd -> definition
val def_get_proctmpl :
  definition -> Name.ident -> def_process_template
val def_get_const :
  definition ->
  Name.ident ->
...
val pol_add_access :
  ...
  access_policy
val pol_add_access_all :
  access_policy ->
  Name.ident * Name.ident list -> access_policy
val pol_add_attack :
  access_policy ->
  Name.ident * Name.ident -> access_policy
val pol_get_attack_opt :
  access_policy -> Name.ident -> Name.ident option
val ldef_add_new_var :
  local_definition ->
  Name.ident * Syntax.expr -> local_definition
...
val lctx_add_new_chan :
  loc:Location.t ->
  local_context -> Name.ident -> local_context
val lctx_add_new_param_chan :
  loc:Location.t ->
  local_context -> Name.ident -> local_context
val lctx_add_new_path :
  loc:Location.t ->
  local_context -> Name.ident -> local_context
val lctx_add_new_process :
  loc:Location.t ->
  local_context -> Name.ident -> local_context
val lctx_add_new_var :
  loc:Location.t ->
  local_context -> Name.ident -> local_context
val lctx_add_new_param :
  loc:Location.t ->
  local_context -> Name.ident -> local_context
val lctx_add_new_loc_var :
  loc:Location.t ->
  local_context -> Name.ident -> local_context
val lctx_add_new_top_var :
  loc:Location.t ->
  local_context -> Name.ident -> local_context
val lctx_add_new_meta :
  loc:Location.t ->
  local_context -> Name.ident -> local_context
val lctx_get_func_arity : local_context -> Name.ident -> int
val lctx_add_new_func :
  loc:Location.t ->
  local_context -> Name.ident * int -> local_context
