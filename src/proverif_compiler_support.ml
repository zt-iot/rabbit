...
let persistent_channel_fact_ident = pv_ident "persistent_channel_fact"
let persistent_local_fact_ident = pv_ident "persistent_local_fact"
let persistent_fact_table_ident = pv_ident "persistent_fact_table"
