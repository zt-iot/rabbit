...
%token SYSTEM LEMMA AT DOT DCOLON REPEAT UNTIL IN THEN ON VAR NEW DEL GET BY EXCL ASSUME STRUCTURE PARAMETER
...
plain_decl:
  ...
  | STRUCTURE t=NAME LPAREN args=separated_list(COMMA, field_type) RPAREN { DeclStructure(t, args) }
